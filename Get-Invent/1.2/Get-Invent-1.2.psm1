...
$MEM = $CollectionMEM | select @{Name="Host"; Expression={$SYS.Name}},MemoryModel,Memory
$PD = $CollectionPD | select @{Name="Host"; Expression={$SYS.Name}},PhysicalDiskModel,Size
$VC = $CollectionVC | select @{Name="Host"; Expression={$SYS.Name}},VideoCard,Display,vRAM
